...
export const AdminDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'projects' | 'articles' | 'skills' | 'contacts' | 'analytics' | 'settings' | 'hero' | 'team' | 'gallery' | 'process'>('overview');
  ...
  const handleSaveHero = async () => {
    try {
      ...
      const response = await fetch(`MOCK_API/site-content`, {
        method: 'PUT',
        headers,
        credentials: 'include',
  ...
  const fetchTeamMembers = async () => {
    try {
      const response = await fetch(`MOCK_API/team`);
      const data = await response.json();
  ...
  const fetchGallery = async () => {
    try {
      const response = await fetch(`MOCK_API/gallery`);
      const data = await response.json();
  ...
  const handleUpdateGalleryItem = async (id: string, updates: any) => {
    try {
      ...
      const response = await fetch(`MOCK_API/gallery/${id}`, {
        method: 'PUT',
        headers,
        credentials: 'include',
        body: JSON.stringify(updates)
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      // Fetch projects
      const projectsRes = await fetch(`MOCK_API/projects`, {
        credentials: 'include',
        headers
      });
      ...
      const articlesRes = await fetch(`MOCK_API/articles/all`, {
        credentials: 'include',
        headers
      });
      ...
      setStats({
        ...
        totalViews: 1247, // Mock for now
        totalContacts: 34, // Mock for now
      });
    } catch (error) {
  ...
  const handleCreateProject = async () => {
    try {
      ...
      const response = await fetch(`MOCK_API/projects`, {
        method: 'POST',
        headers,
        credentials: 'include',
        body: JSON.stringify({
  ...
  const handleUpdateProject = async () => {
    ...
    try {
      ...
      const response = await fetch(`MOCK_API/projects/${editingProject._id}`, {
        method: 'PUT',
        headers,
        credentials: 'include',
        body: JSON.stringify({
  ...
  const handleDeleteProject = async (id: string) => {
    try {
      ...
      const response = await fetch(`MOCK_API/projects/${id}`, {
        method: 'DELETE',
        headers,
        credentials: 'include'
      });
  ...
  const handleToggleFeatured = async (project: Project) => {
    try {
      ...
      const response = await fetch(`MOCK_API/projects/${project._id}`, {
        method: 'PUT',
        headers,
        credentials: 'include',
        body: JSON.stringify({
  ...
  const handleCreateArticle = async () => {
    try {
      ...
      const response = await fetch(`MOCK_API/articles`, {
        method: 'POST',
        headers,
        credentials: 'include',
        body: JSON.stringify({
  ...
  const handleUpdateArticle = async () => {
    ...
    try {
      ...
      const response = await fetch(`MOCK_API/articles/${editingArticle._id}`, {
        method: 'PUT',
        headers,
        credentials: 'include',
        body: JSON.stringify({
  ...
  const handleDeleteArticle = async (id: string) => {
    try {
      ...
      const response = await fetch(`MOCK_API/articles/${id}`, {
        method: 'DELETE',
        headers,
        credentials: 'include'
      });
  ...
  const fetchAbout = async () => {
    try {
      const response = await fetch(`MOCK_API/about/me`, {
        credentials: 'include'
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const handleSaveAbout = async () => {
    ...
    try {
      const response = await fetch(`MOCK_API/about`, {
        method: 'PUT',
  ...
  const fetchSkills = async () => {
    try {
      const response = await fetch(`MOCK_API/skills`);
      const data = await response.json();
  ...
  const handleUpdateSkill = async () => {
    ...
    try {
      ...
      const response = await fetch(`MOCK_API/skills/${editingSkill._id}`, {
        method: 'PUT',
        headers,
        credentials: 'include',
        body: JSON.stringify(skillForm)
  ...
  const handleDeleteSkill = async (id: string) => {
    try {
      ...
      const response = await fetch(`MOCK_API/skills/${id}`, {
        method: 'DELETE',
        headers,
        credentials: 'include'
      });
